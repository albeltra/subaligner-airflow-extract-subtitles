...
if not os.path.exists(output_file_path + '.en.srt') or ( not os.path.exists(output_file_path + '.srt.srt') and not os.path.exists(output_file_path + '.pgs.srt') and not os.path.exists(output_file_path + '.vob.srt')):
